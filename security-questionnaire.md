...
Yes, but not directly. [Accelerometer] specification requires user [permission] and implementation
...
Not directly; However, accelerometer data can be used in combination with other sensors to
calculate, things like speed, how many steps were taken, etc., therefore, infer new position
of the end user. [Accelerometer] requires [user permission][permission]
...
[security-and-privacy]: https://w3c.github.io/accelerometer/#security-and-privacy
[permission]: https://w3c.github.io/permissions/#dom-permissionname-accelerometer
